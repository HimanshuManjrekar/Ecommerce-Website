...
<div class="carousel slide" id="slides" data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="img/UE_category_hero_desktop.jpg" alt="">
			<div class="carousel-caption">
				<!-- <h1 class="display-2"><b>Introducing</b></h1> -->
                <!-- <h3>#Feel The Bass</h3> -->
                <!-- <a href="aboutus.php">
...
<div class="container-fluid padding">
	<div class="row Welcome text-center">
		<div class="col-12">
			<h1 class="display-5">Portable Speakers.</h1>
		</div>
		<hr>
		<div class="col-12">
			<p class="lead">Possibly the only speaker you need. Rålis follows effortlessly no matter
				 what mood you’re in or what vibe you’re on. The perfect portable solution for when your idea of home extends far 
				 beyond living space walls.
it.
</p>
		</div>
	</div>
...
<?PHP
	...
	$query = " SELECT * FROM `speakers` order by id ASC ";
